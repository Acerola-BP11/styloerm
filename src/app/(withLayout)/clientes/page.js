    ...
    return (
        <div className='h-full w-full flex flex-row items-center'>
            <div className="flex flex-col justify-center items-center w-1/2">
                <Link href="/clientes/novo" className="mb-10"><span className="text-lg font-bold">Cadastrar Clientes</span></Link>
            ...
            <div className="w-1/2 flex flex-col justify-center items-center">
                <Link href="/clientes/lista" className="mb-10"><span className="text-lg font-bold">Listar Clientes</span></Link>
